  ...
  return (
    <div className="space-y-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogTrigger asChild>
              <Button onClick={() => { setSelectedSubject(null); setIsDialogOpen(true); }} size="sm" className="rounded-2xl bg-blue-50 hover:bg-blue-100 active:bg-blue-50 border border-blue-100 dark:bg-blue-900/30 dark:text-blue-400 dark:hover:bg-blue-900/50 dark:active:bg-blue-900/30 dark:border-blue-800/40 text-blue-700 font-bold shadow-sm h-9 px-4 focus-visible:ring-0 focus-visible:ring-offset-0">
      ...
      <ConfirmationDialog
        ...
        description={`Apakah Anda yakin ingin menghapus data ${terminology.subject.toLowerCase()} "${subjectToDelete?.name || ""}"?`}
        confirmLabel="Hapus"
