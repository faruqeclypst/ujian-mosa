    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        {loading ? (
          Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="bg-card p-5 rounded-2xl border border-slate-200/60 dark:border-slate-800/40 shadow-sm flex items-center gap-3.5">
      ...
      <div className="bg-card p-5 rounded-2xl border border-slate-200/60 dark:border-slate-800/40 shadow-sm backdrop-blur-sm">
        ...
        <div className="h-[280px] w-full mt-2">
          {loading ? (
             <div className="flex items-end gap-4 h-full px-4 pb-8">
