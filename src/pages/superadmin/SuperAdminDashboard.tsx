           ...
           <div className="bg-slate-100/80 border border-slate-200 rounded-xl p-1 flex shadow-sm">
              <button
                ...
                className={`px-6 py-2 rounded-lg text-sm font-bold transition-all ${
                  tab === "schools" ? "bg-white text-blue-700 shadow border-slate-200" : "text-slate-500 hover:text-slate-700"
                }`}
              >
                Instansi Aktif
              </button>
              <button
                ...
                className={`px-6 py-2 rounded-lg text-sm font-bold transition-all flex items-center gap-2 ${
                  tab === "requests" ? "bg-white text-blue-700 shadow border-slate-200" : "text-slate-500 hover:text-slate-700"
                }`}
              >
                      ...
                      <div className="space-y-2 max-w-[140px]">
                        <div className="flex justify-between items-center">
                           <span className={`text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-md ${
                             school.plan === 'pro' ? 'bg-amber-100 text-amber-700 border border-amber-200' : 'bg-slate-100 text-slate-600 border border-slate-200'
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <button
                          ...
                          className={`p-2 bg-white border border-slate-200 rounded-lg transition-all shadow-sm ${
                            school.is_active
              ...
              <tbody className="divide-y divide-slate-100">
                {requests.length === 0 ? (
                  ...
                  <tr key={req.id} className="hover:bg-slate-50/80 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                       <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider inline-flex items-center gap-1.5 border ${
